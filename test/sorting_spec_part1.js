...
describe("Part 1", function() {
  ...
  describe("#swap", function() {
    ...
    let swap = require("../algorithms/sorting_part1").swap;
  ...
  describe("#bubbleSort", function(){
    ...
    let bubbleSort = require("../algorithms/sorting_part1").bubbleSort;
  ...
  describe("#selectionSort", function(){
    ...
    let selectionSort = require("../algorithms/sorting_part1").selectionSort;
